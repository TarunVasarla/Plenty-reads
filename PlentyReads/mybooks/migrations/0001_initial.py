    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(default=datetime.datetime(2015, 12, 1, 12, 55, 34, 276000))),
                ('update_date', models.DateTimeField(default=datetime.datetime(2015, 12, 1, 12, 55, 34, 276000))),
        ...
        migrations.AddField(
            model_name='html',
            name='pdf',
            field=models.ForeignKey(to='mybooks.Pdf'),
        ),
        migrations.AddField(
            model_name='book',
            name='genre',
